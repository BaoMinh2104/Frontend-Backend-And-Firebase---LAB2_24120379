...
const TOKEN_KEY = "image_captioning.auth.token";
const REFRESH_TOKEN_KEY = "image_captioning.auth.refresh_token";
const EMAIL_KEY = "image_captioning.auth.email";
const UID_KEY = "image_captioning.auth.uid";
const DISPLAY_NAME_KEY = "image_captioning.auth.display_name";
const PHOTO_URL_KEY = "image_captioning.auth.photo_url";
const PROVIDERS_KEY = "image_captioning.auth.providers";

export class AuthFlowError extends Error {
  code: string;
  email?: string;

  constructor(code: string, message: string, options: { email?: string } = {}) {
    super(message);
